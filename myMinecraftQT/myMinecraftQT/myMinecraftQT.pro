...
win32:CONFIG(release, debug|release): LIBS += -L$$PWD/../ -lopengl32
else:win32:CONFIG(debug, debug|release): LIBS += -L$$PWD/../ -lopengl32
else:unix: LIBS += -L$$PWD/../ -lopengl32

INCLUDEPATH += $$PWD/../
DEPENDPATH += $$PWD/../

win32:CONFIG(release, debug|release): LIBS += -L$$PWD/../ -lglu32
else:win32:CONFIG(debug, debug|release): LIBS += -L$$PWD/../ -lglu32
else:unix: LIBS += -L$$PWD/../ -lglu32
