...
#include "../../ft232rl_2/ft232rl_class.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ft232rl_class_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 27, 16) // "maininmainwindow"
    ...
    "ft232rl_class\0refresh\0\0str\0maininmainwindow"
};
...
void ft232rl_class::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->maininmainwindow(); break;
        default: ;
        }
...
void *ft232rl_class::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ft232rl_class.stringdata))
